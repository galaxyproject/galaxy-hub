<template>
    <div class="platform-map-container">
        <div v-if="platformsWithLocations.length > 0" class="map-wrapper">
            <div ref="mapContainer" :class="['ol-map', mapTheme === 'dark' ? 'galaxy-dark-mode' : 'galaxy-pale-mode']"></div>
            <div class="map-legend">
                <div class="legend-header">
                    ...
                    >
                        <svg v-if="mapTheme === 'dark'" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
export default {
    ...
    methods: {
        ...
        toggleMapTheme() {
            this.mapTheme = this.mapTheme === 'dark' ? 'pale' : 'dark';
        },
        ...
        showPopup(coordinate, platform) {
            ...
            popupElement.innerHTML = `
                ...
                <a href="${platform.path}" class="inline-block px-4 py-2 text-sm font-medium rounded-md transition-colors bg-galaxy-primary text-white hover:bg-galaxy-primary/90 mt-2" target="_new">View Details</a>

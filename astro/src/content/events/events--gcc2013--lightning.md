...
slug: events/gcc2013/lightning
---
## Table of contents

* [Lightning Talks](#lightning-talks)
  * [Day 1: Monday 1 July](#day-1-monday-1-july)
    * [Medilaxy: A Galaxy Platform For Medical Image Analysis](#medilaxy-a-galaxy-platform-for-medical-image-analysis)
    * [Establishing a genomics analysis workbench](#establishing-a-genomics-analysis-workbench)
    * [LiSIs: a Galaxy-based platform for Life Science Informatics Research](#lisis-a-galaxy-based-platform-for-life-science-informatics-research)
    * [Software Carpentry - Helping scientists build better software since 1998](#software-carpentry---helping-scientists-build-better-software-since-1998)
    * [Galaxy Integration into an External Information System](#galaxy-integration-into-an-external-information-system)
    * [Implementing Next Generation Web Server in Galaxy](#implementing-next-generation-web-server-in-galaxy)
    * [Galaxy Scratchbook: How to view, customize, and layout multiple visualizations](#galaxy-scratchbook-how-to-view-customize-and-layout-multiple-visualizations)
    * [Unraveling the code of our Galaxy](#unraveling-the-code-of-our-galaxy)
  * [Day 2: Tuesday 2 July](#day-2-tuesday-2-july)
    * [How to set up a Galaxy service you can count upon](#how-to-set-up-a-galaxy-service-you-can-count-upon)
    * [GenesCloud : Bioinformatics cloud computing infrastructure](#genescloud--bioinformatics-cloud-computing-infrastructure)
    * [Andromeda: NBIC Galaxy at Surfsara's HPC cloud](#andromeda-nbic-galaxy-at-surfsaras-hpc-cloud)
    * [Workflow4Metabo](#workflow4metabo)
    * [GLM for testing differential expression and GSEA in Galaxy](#glm-for-testing-differential-expression-and-gsea-in-galaxy)
    * [Analysis of DNA methylation data using galaxy](#analysis-of-dna-methylation-data-using-galaxy)
    * [Galaxy on an elastic HPC cluster at AWS](#galaxy-on-an-elastic-hpc-cluster-at-aws)
    * [Running Galaxy workflows using the CLC Main Workbench](#running-galaxy-workflows-using-the-clc-main-workbench)
    * [Proteogenomics with Galaxy](#proteogenomics-with-galaxy)
    * ["Lightweight" HPC Client: Leveraging Galaxy Tool configs](#lightweight-hpc-client-leveraging-galaxy-tool-configs)
    * [ChemicalToolBoX: Cheminformatics inside the Galaxy](#chemicaltoolbox-cheminformatics-inside-the-galaxy)
* [Goals](#goals)
* [Timing](#timing)
* [Slides](#slides)
* [Gratuitous Advice](#gratuitous-advice)
...
During [Session 4](/events/gcc2013/program/#day-1-main-meeting-1-july), moderated by [Ross Lazarus](/people/fubar/).
...
<sup>1</sup> Computer Science Department, Johannes Gutenberg University, Mainz<br /> <sup>2</sup> Department of Neurology, University Medical Center, Johannes Gutenberg University, Mainz<br /> <sup>3</sup> Germany Neuroimage Center (NIC) of the FTN- Focus Program Translational Neuroscience, Johannes Gutenberg University, Mainz, Germany
...
<sup>1</sup> Victorian Life Sciences Computation Initiative, University of Melbourne, Australia<br /> <sup>2</sup> University of Queensland, Brisbane, Australia<br />
...
**Lex Nederbragt**<sup>1</sup>, Karin Lagesen<sup>2</sup> <sup>1</sup> Norwegian Sequencing Centre (NSC) and Centre for Ecological and Evolutionary Synthesis (CEES), Dept. of Biosciences, University of Oslo, Oslo, Norway<br /> <sup>2</sup> Norwegian Sequencing Centre (NSC) and Department of Medical Genetics, Oslo University Hospital, University of Oslo, Oslo, Norway
...
2. The Galaxy user check system permissions on input and output files for the current user
3. If it pass the permissions checking step, the Galaxy user execute the analysis, and write the results into the corresponding project directory with the provided file name (but still create  the original dataset, which is now a symbolic link to the real output file)
4. Finally, the Galaxy user gives output files to the current user
...
During [Session 8](/events/gcc2013/program/#day-2-main-meeting-2-july), moderated by [Hans-Rudolf Hotz](/people/hansrudolf-hotz/).
...
<sup>1</sup> ABgenomica, Versailles France <br /> <sup>2</sup> Laboratoire de l'Accélérateur Linéaire, Orsay France
...
**[Ross Lazarus](/people/fubar/)**, Mark Ziemann and Antony Kaspi.

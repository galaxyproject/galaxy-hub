...
* [During the event](#during-the-event)
  * * [Issues to work on](#issues-to-work-on)
    * [Featured issues](#featured-issues)
...
| **[Galaxy Tools Extension & Galaxy Language Server](https://github.com/galaxyproject/galaxy-language-server/)** | Backend | Galaxy Tool Language Server.  | **[paper-cut](https://github.com/galaxyproject/galaxy-language-server/labels/paper-cut)** |
...
| **[CloudMan](https://github.com/galaxyproject/cloudman)** | Admin | Managing instances on cloud infrastructures. | **[good first issue](https://github.com/galaxyproject/cloudman/labels/good%20first%20issue)** |
| **[Ansible Galaxy](https://github.com/galaxyproject/ansible-galaxy/)** | Admin | Galaxy deployment recipes.  | **[paper-cut](https://github.com/galaxyproject/ansible-galaxy/labels/paper-cut)** |

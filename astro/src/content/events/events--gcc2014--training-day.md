---
title: Training Day
slug: events/gcc2014/training-day
---
## Table of contents
...
* [Prerequisites and Technology](#prerequisites-and-technology)
  ...
  * [Software](#software)
* [Topics](#topics)
  * [Using Galaxy Topics](#using-galaxy-topics)
    * [Raisins and Rabbit Turds: NGS Quality Control with Galaxy](#raisins-and-rabbit-turds-ngs-quality-control-with-galaxy)
    * [Training with Galaxy: a Genome Assembly Example](#training-with-galaxy-a-genome-assembly-example)
    * [RNA-Seq Analysis with Galaxy and the Tuxedo Suite](#rna-seq-analysis-with-galaxy-and-the-tuxedo-suite)
    * [RNA-Seq Analysis with Galaxy and Alternative Tools](#rna-seq-analysis-with-galaxy-and-alternative-tools)
    * [Visualization of NGS data](#visualization-of-ngs-data)
    * [3D Genome Analysis with Galaxy](#3d-genome-analysis-with-galaxy)
  * [Deployment and Development Topics](#deployment-and-development-topics)
    * [Galaxy Installation and Administration](#galaxy-installation-and-administration)
    * [Galaxy on a Cluster - User and Project Management](#galaxy-on-a-cluster---user-and-project-management)
    ...
    * [Galaxy Internals: Flow control within Galaxy](#galaxy-internals-flow-control-within-galaxy)
    * [Scriptable Bioinformatics Cloud Infrastructures with Cloud BioLinux, CloudMan & Galaxy](#scriptable-bioinformatics-cloud-infrastructures-with-cloud-biolinux-cloudman--galaxy)
* [Nomination, Voting and Topic Selection](#nomination-voting-and-topic-selection)
* [Feedback from the GCC2014 Training Day](#feedback-from-the-gcc2014-training-day)

...
slug: events/asms2013
---
## Table of contents

* [Workshop: The Galaxy Framework as a Solution for MS-based Informatics](#workshop-the-galaxy-framework-as-a-solution-for-ms-based-informatics)
* [Posters Directly About Galaxy](#posters-directly-about-galaxy)
  * [User friendly MS analysis by taking the Galaxy environment to the cloud](#user-friendly-ms-analysis-by-taking-the-galaxy-environment-to-the-cloud)
  * [Galaxy-P:  Transforming MS-based proteomic informatics via innovative workflow development, dissemination, standardization and transparency](#galaxy-p--transforming-ms-based-proteomic-informatics-via-innovative-workflow-development-dissemination-standardization-and-transparency)
  * [Reproducible Proteomic Workflows using Extensions to the Galaxy Framework](#reproducible-proteomic-workflows-using-extensions-to-the-galaxy-framework)
  * [An Integrated Systems Biology Platform for Complete Proteogenomic Analysis.](#an-integrated-systems-biology-platform-for-complete-proteogenomic-analysis)
  * [Automated Quantification and Analysis of SILAC-iTRAQ Dual-labeled Data](#automated-quantification-and-analysis-of-silac-itraq-dual-labeled-data)
* [Posters Utilizing Galaxy](#posters-utilizing-galaxy)
  * [Building Proteomic Application Platforms for Cloud Computing Environments with CloudBioLinux](#building-proteomic-application-platforms-for-cloud-computing-environments-with-cloudbiolinux)
  * [A comprehensive characterization of the pig islet proteome: PTMs, amino acid substitutions and novel isoforms](#a-comprehensive-characterization-of-the-pig-islet-proteome-ptms-amino-acid-substitutions-and-novel-isoforms)
  * [Quantitative Analysis of the C2C12 and Mouse Skeletal Muscle Proteomes using a Multiplexing Strategy](#quantitative-analysis-of-the-c2c12-and-mouse-skeletal-muscle-proteomes-using-a-multiplexing-strategy)
  * [Bronchoalveolar Lavage Fluid Protein Profiling In ARDS: Early Differences Between Survivors And Non-Survivors](#bronchoalveolar-lavage-fluid-protein-profiling-in-ards-early-differences-between-survivors-and-non-survivors)
  * [Comparing Lung Protein Expression for Biomarkers  Within the Disease Phenotypes of COPD and Lung Cancer](#comparing-lung-protein-expression-for-biomarkers--within-the-disease-phenotypes-of-copd-and-lung-cancer)
...
<sup>1</sup> Science for Life Laboratory, Solna, SWEDEN; <br /> <sup>2</sup> 2Karolinska Institutet, Stockholm, Sweden; <br /> <sup>3</sup> KTH Royal Insitute of Technology, Stockholm, Sweden
...
<sup>1</sup> University of Minnesota, Minneapolis, MN; <br /> <sup>2</sup> University of Minnesota Supercomputing Institute, Minneapolis, MN

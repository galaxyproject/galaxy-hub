---
slug: events/gcc2012/training-day/ws5
---
## Table of contents

* [Workshop 5: Installing Your Own Galaxy](#workshop-5-installing-your-own-galaxy)
  * [Create a new user for Galaxy](#create-a-new-user-for-galaxy)
  * [Install Mercurial](#install-mercurial)
  * [Clone the Galaxy Distribution](#clone-the-galaxy-distribution)
  * [Configure Galaxy](#configure-galaxy)
  * [Install PostgreSQL](#install-postgresql)
  * [Create PostgreSQL user and database](#create-postgresql-user-and-database)
  * [Start Galaxy for the first time](#start-galaxy-for-the-first-time)
  * [Install an init script to start Galaxy automatically](#install-an-init-script-to-start-galaxy-automatically)
  * [Start Galaxy from the init script](#start-galaxy-from-the-init-script)
  * [Install nginx](#install-nginx)
  * [Configure and start nginx](#configure-and-start-nginx)
  * [Configure Galaxy for nginx upload/download](#configure-galaxy-for-nginx-uploaddownload)
  * [Install ProFTPd](#install-proftpd)
  * [Configure ProFTPd](#configure-proftpd)
  * [Configure Galaxy to use Sun Grid Engine](#configure-galaxy-to-use-sun-grid-engine)
  * [Run multiple Galaxy processes](#run-multiple-galaxy-processes)
  * [Configure the Distributed Object Store](#configure-the-distributed-object-store)

# Workshop 5: Installing Your Own Galaxy

* [universe\_wsgi.ini modified with all of the changes below](https://depot.galaxyproject.org/hub/attachments/documents/presentations/gcc2012/WS5/universe_wsgi.ini)
...
Note that under Debian/Ubuntu, `nginx-extras` contains 3rd party modules, including the nginx\_upload\_module, which we need for the advanced nginx config.  This module may also be available in nginx packages for Fedora-based distributions, but if not, you may have to compile nginx by hand to get the upload module.
...
* `nginx_upload_store = /home/galaxy/nginx_upload_store` - This is the directory that files uploaded to the nginx\_upload\_module will be saved to.  It must match the path set in the nginx config above.

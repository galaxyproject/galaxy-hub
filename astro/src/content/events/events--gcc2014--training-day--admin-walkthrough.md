...
slug: events/gcc2014/training-day/admin-walkthrough
---
## Table of contents

* [Setting up a Local Galaxy Tutorial (Part I)](#setting-up-a-local-galaxy-tutorial-part-i)
  * [Clone (download) Galaxy](#clone-download-galaxy)
    * [References](#references)
  * [Update to the stable branch](#update-to-the-stable-branch)
  * [Start Galaxy](#start-galaxy)
  * [Installing tools from the Tool Shed](#installing-tools-from-the-tool-shed)
    * [Topics for this section](#topics-for-this-section)
    * [Galaxy configuration for Tool Shed installs](#galaxy-configuration-for-tool-shed-installs)
    * [Install a tool from the Tool Shed](#install-a-tool-from-the-tool-shed)
    * [References](#references-1)
  * [Managing local data](#managing-local-data)
    * [Topics for this section](#topics-for-this-section-1)
    * [Adding local data with a Galaxy Data Manager](#adding-local-data-with-a-galaxy-data-manager)
    * [References](#references-2)
* [Setting up a Local Galaxy Tutorial (Part II)](#setting-up-a-local-galaxy-tutorial-part-ii)
  * [Install and configure PostgreSQL](#install-and-configure-postgresql)
  * [Create a new user for Galaxy](#create-a-new-user-for-galaxy)
  * [Create a Python virtual environment](#create-a-python-virtual-environment)
  * [Clone (download) Galaxy](#clone-download-galaxy-1)
  * [Configure Galaxy](#configure-galaxy)
  * [Start a Galaxy server to complete first run setup](#start-a-galaxy-server-to-complete-first-run-setup)
  * [Install Ansible and nginx](#install-ansible-and-nginx)
    * [Ansible](#ansible)
    * [Build nginx](#build-nginx)
    * [Install nginx](#install-nginx)
  * [Install uWSGI and supervisord](#install-uwsgi-and-supervisord)
  * [Configure nginx](#configure-nginx)
  * [Configure supervisord](#configure-supervisord)
  * [Start Galaxy and nginx](#start-galaxy-and-nginx)
  * [References](#references-3)
  * [Load external data in a data library](#load-external-data-in-a-data-library)
* [Extra Activities (Time and Interest Permitting)](#extra-activities-time-and-interest-permitting)
  * [Using Slurm or Torque/PBS](#using-slurm-or-torquepbs)
  * [Shipping Jobs to Remote Resources with Pulsar](#shipping-jobs-to-remote-resources-with-pulsar)
    * [Installing Pulsar with Ansible](#installing-pulsar-with-ansible)
  * [Additional topic candidates](#additional-topic-candidates)
* [Transcripts](#transcripts)
  * [Adding local data by hand](#adding-local-data-by-hand)
...
* Follow the [tutorial on installing tools from the Tool Shed](/admin/tools/add-tool-from-toolshed-tutorial/). In brief:
  ...
  * Click the popup icon for **bwa\_wrappers** owned by **devteam** and select **Install to Galaxy**
...
* Check **data\_manager\_fetch\_genome\_all\_fasta** and **data\_manager\_bwa\_index\_builder**, then click **Install to Galaxy** (at the bottom of the page)
* Click **Install**
...
* `use_remote_user` and `remote_user_maildomain` - Use your institution's existing authentication system to log in to Galaxy. [Apache documentation](/admin/config/apache-external-user-auth/) or [nginx documentation](https://galaxyproject.org/admin/config/nginx-external-user-auth/)

...
slug: events/gcc2013/training-day
---
## Table of contents

* [Registration](#registration)
* [Schedule](#schedule)
* [Prerequisites and Technology](#prerequisites-and-technology)
  * [Hardware](#hardware)
  * [Software](#software)
* [Topics](#topics)
  * [General Workshops](#general-workshops)
    * [Introduction to Galaxy and the Galaxy Ecosystem](#introduction-to-galaxy-and-the-galaxy-ecosystem)
    * [Running Galaxy on the Cloud](#running-galaxy-on-the-cloud)
  * [Biologist Centric Workshops](#biologist-centric-workshops)
    * [RNA-Seq Analysis with Galaxy](#rna-seq-analysis-with-galaxy)
    * [Statistical Genome Analysis with Galaxy](#statistical-genome-analysis-with-galaxy)
    * [ChIP-Seq Analysis with Galaxy](#chip-seq-analysis-with-galaxy)
    * [Variant and SNP Analysis with Galaxy](#variant-and-snp-analysis-with-galaxy)
  * [Galaxy Deployment and Development Workshops](#galaxy-deployment-and-development-workshops)
    * [Installing and Maintaining a Local Galaxy Server](#installing-and-maintaining-a-local-galaxy-server)
    * [Introduction to Tool and Data Source Configuration](#introduction-to-tool-and-data-source-configuration)
    * [Advanced Tool and Data Source Configuration](#advanced-tool-and-data-source-configuration)
    * [Galaxy Tool Shed](#galaxy-tool-shed)
    * [The Galaxy API](#the-galaxy-api)
    * [Galaxy Code and Storage Architecture](#galaxy-code-and-storage-architecture)
* [Training Day Sponsor](#training-day-sponsor)
* [Nomination, Voting and Topic Selection](#nomination-voting-and-topic-selection)
* [Software Carpentry Boot Camp](#software-carpentry-boot-camp)
...
* A "simple" executable tool you would like to wrap that takes and/or creates existing Galaxy datatypes like bed/fastq/bam etc such as one of the [bedTools executables](http://code.google.com/p/bedtools/).
  ...
  <tr>
    <th style=" vertical-align: top;"> Links </th>
    <td style=" vertical-align: top; background-color: #ffffcc;"> <a href='/events/gcc2013/training-day/intro-tool-data/'>Workshop material</a> </td>
  </tr>
</table>
...
* Knowledge and comfort with the Unix/Linux command line interface and a text editor. If you don't know what cd, mv, rm, mkdir, chmod, grep and so on can do then you will struggle in this workshop.
  ...
  <tr>
    <th style=" vertical-align: top;"> Outcomes </th>
    <td style=" vertical-align: top; background-color: #ffffcc;"> <a href='/events/gcc2013/training-day/advance-tool-data/'>Workshop materials</a> </td>
  </tr>
</table>
...
* Knowledge of a programming or scripting language.
  ...
  <tr>
    <th style=" vertical-align: top;"> Links </th>
    <td style=" vertical-align: top; background-color: #ffffcc;"> <a href='/events/gcc2013/training-day/api/'>Workshop Materials</a> </td>
  </tr>
</table>
...
<table class="table">
  <tr>
    <th style=" vertical-align: top;"> Instructors </th>
    <td style=" background-color: #ffffcc;"> <a href='/people/james-taylor/'>James Taylor</a>, <a href='http://emory.edu/'>Emory University</a> <br /> <a href='/people/nate/'>Nate Coraor</a>, <a href='http://psu.edu/'>Penn State University</a> </td>
  </tr>
  <tr>
    <th style=" vertical-align: top;"> Content </th>

...
function convertFontAwesomeToLucide(content) {
  ...
  const icons = {
    ...
    'share-2': '<circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><path d="m8.59 13.51 6.83 3.98"/><path d="m8.59 10.49 6.83-3.98"/>',
    ...
    'wand-2': '<path d="m21.64 3.64-1.28-1.28a1.21 1.21 0 0 0-1.72 0L2.36 18.64a1.21 1.21 0 0 0 0 1.72l1.28 1.28a1.2 1.2 0 0 0 1.72 0L21.64 5.36a1.2 1.2 0 0 0 0-1.72"/><path d="m14 7 3 3"/>',
  ...
  const faToLucide = {
    'fa-laptop': 'laptop', 'fa-external-link-alt': 'external-link', 'fa-external-link': 'external-link',
    'fa-share-alt': 'share-2', 'fa-exclamation-circle': 'alert-circle', 'fa-files-o': 'files',
    'fa-magic': 'wand-2', 'fa-file': 'file', 'fa-envelope': 'mail', 'fa-video': 'video',
    'fa-folder': 'folder', 'fa-cog': 'settings', 'fa-pencil-alt': 'pencil', 'fa-book': 'book',
    'fa-slideshare': 'presentation', 'fa-question-circle': 'help-circle', 'fa-question-circle-o': 'help-circle',
    'fa-list-ul': 'list', 'fa-list-alt': 'list', 'fa-mouse': 'mouse', 'fa-copy': 'copy',
    'fa-check-square': 'square-check', 'fa-tv': 'tv', 'fa-comments-o': 'message-square',
    'fa-sync': 'refresh-cw', 'fa-keyboard': 'keyboard', 'fa-eye': 'eye',
    'fa-caret-square-down': 'chevron-down', 'fa-graduation-cap': 'graduation-cap',
    'fa-bullseye': 'target', 'fa-calendar': 'calendar', 'fa-cloud': 'cloud', 'fa-coffee': 'coffee',
    'fa-wrench': 'wrench', 'fa-fighter-jet': 'rocket', 'fa-road': 'monitor', 'fa-github': 'github',
    'fa-twitter': 'twitter', 'fa-linkedin': 'linkedin', 'fa-whatsapp': 'message-circle',
    'fa-mastodon': 'message-circle', 'fa-orcid': 'user', 'fa-matrix': 'grid-3x3', 'fa-topic': 'hash',
    'fa-chalkboard-teacher': 'presentation', 'fa-laptop-code': 'code', 'fa-optin-monster': 'user',
    'fa-bug': 'alert-circle',
  };

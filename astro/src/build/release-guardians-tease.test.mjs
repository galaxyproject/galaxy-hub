...
describe('extractPlainTease', () => {
    ...
    it('skips paragraphs that contain markdown structural lines (headings)', () => {
        const body = [
            '## Summary',
            '',
            'Fixes the regression in the upload widget.',
        ].join('\n');
    ...
    it('strips heading lines glued to following prose so the prose stands alone', () => {
        ...
        const body = [
            ...
            'A badge at the top indicates the current activity bar context.',
        ].join('\n');
    ...
    it('skips a dirty first sentence and starts at the first clean one in the paragraph', () => {
        const body = 'Addresses #1234 and resolves https://example.com/issue. The trash icon replaces the red cross icon for clarity.';
    ...
    it('stops accumulating at the first dirty sentence', () => {
        const body = 'First clean sentence here. Second clean sentence here. Third sentence mentions #1234. Fourth would be clean.';

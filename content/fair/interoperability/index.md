...
[To our knowledge](https://galaxyproject.org/#publications--citations), the Galaxy platform is cited more than 11,000 times ([Zotero](https://www.zotero.org/groups/1732893/galaxy/)). Publications that explicitly mention usegalaxy.eu as a resource can be accessed at [citations page](/eu/citations/). A means to assess the impact of Galaxy on training are shown in the [TIaaS](https://usegalaxy.eu/tiaas/) statistics that we gather at https://usegalaxy.eu/tiaas/stats. 14,000 trainees is the lower bound, since we can only track the officially registered training events.

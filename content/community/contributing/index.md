...
If you want to contribute to the Galaxy Project, there are plenty of ways to do it. And here is the good news: __you can contribute with code, but not only with code__!
...
- __How?__ 
  ...
  - There are [__Working Groups__](https://galaxyproject.org/community/wg/) focused on particular parts of the ecosystem, you can reach out to them if you want to help.
...
- __How?__ The GTN has [tutorials on how to contribute](https://training.galaxyproject.org/training-material/topics/contributing/).
...
- Give a workshop, we provide you with the [infrastructure for free](https://galaxyproject.eu/tiaas.html)! Let us know if you do, and we will announce it on the [Events page](https://galaxyproject.org/events/), our newsletter and social media!

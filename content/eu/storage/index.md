...
⚠️ Currently, Galaxy does not offer a way to move data from short term storage to long term storage. (If you really want to keep the data, the only option is to download the history and then upload it again once you've changed your settings to long term storage.)

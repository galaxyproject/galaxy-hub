...
comments:
  ...
  - "[Real time status](https://stats.uptimerobot.com/gXd4fsKqVy/798073512)"
  - "Provides reference data for plant species from the [PLAZA data warehouse](https://usegalaxy-be.github.io/2019/07/01/PLAZA-reference-data)."
user_support:
  - "Email: datacore.galaxy(at)vib.be"
quotas:
  - "Free to use"
  - "50 GB for any registered users, more can be requested by filling in the [request-quota form](https://usegalaxy-be.github.io/request-quota)."
citations:
  - "[UseGalaxy.be

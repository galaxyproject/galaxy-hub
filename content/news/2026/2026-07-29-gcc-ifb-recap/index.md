---
title: "The French Bioinformatics Community at GCC2026 in Clermont-Ferrand"
date: "2026-07-29"
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1rem; margin: 1.5rem 0;">
  <figure style="margin: 0;">
    <img src="./images/55372499142_f1bc9a1ca0_c.jpg" alt="A person wearing glasses and a yellow shirt with a blue lanyard smiles while sitting at a table with a water bottle and a white pitcher in the foreground." style="width: 100%; border-radius: 10px;" />
  </figure>
  <figure style="margin: 0;">
    <img src="./images/55370941573_372e6a7efc_c.jpg" alt="Three people wearing lanyards engage in a conversation, with one person holding a drink." style="width: 100%; border-radius: 10px;" />
  </figure>
  <figure style="margin: 0;">
    <img src="./images/55373859980_5d7af7e82e_c.jpg" alt="Two people wearing glasses collaborate over a laptop covered in stickers, with one person resting their head on their hand while the other leans in to look at the screen." style="width: 100%; border-radius: 10px;" />
  </figure>
</div>
...
<figure style="margin: 1.5rem 0 2rem 0;">
  <img src="./images/group.jpg" alt="French Bioinformatics Community GCC2026 attendees gathered for the conference group photo in Clermont-Ferrand, France." style="width: 100%; border-radius: 12px;" />
</figure>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1rem; margin: 1.5rem 0;">
  <figure style="margin: 0;">
    <img src="./images/55371011020_a5f130d8d4_c.jpg" alt="A smiling person with glasses and a blue lanyard stands in front of a poster display at a conference." style="width: 100%; border-radius: 10px;" />
  </figure>
  <figure style="margin: 0;">
    <img src="./images/55370808086_b09dcb8538_c.jpg" alt="A person with a beard and a blue lanyard holds a paper cup while smiling and engaging in conversation with others at an indoor event." style="width: 100%; border-radius: 10px;" />
  </figure>
  <figure style="margin: 0;">
    <img src="./images/55370736653_c49097fe5b_c.jpg" alt="A person wearing a cap, orange sunglasses, and a GCC2017 tee-shirt drinks from a paper cup while making a peace sign with their fingers." style="width: 100%; border-radius: 10px;" />
  </figure>
</div>
...
<figure style="margin: 1.5rem 0 2rem 0;">
  <img src="./images/55373440641_783f446020_c.jpg" alt="A person wearing a gray shirt and a blue lanyard speaks into a microphone at a podium with a laptop." style="width: 100%; border-radius: 12px;" />
</figure>
...
<figure style="margin: 1.5rem 0 2rem 0;">
  <img src="./images/55373448401_d1b534e372_c.jpg" alt="A person wearing a white T-shirt with the text 'Galaxy: La science ouverte, partout, par tou·te·s' works on a laptop at a table during the cofest." style="width: 100%; border-radius: 12px;" />
</figure>

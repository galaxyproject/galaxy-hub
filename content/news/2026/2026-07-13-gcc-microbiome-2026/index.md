...
<p align="center"><img src="images/Alzheimer’s disease_GCC2026.pptx.png" alt="Mina Hojat Ansari presenting Galaxy-based workflows for genome-resolved and multi-kingdom microbiome analysis: application to the nasal microbiome in Alzheimer's disease" width="50%"/></p>
...
### Upcoming microbiome-related ELIXIR developments presented at the ELIXIR F2F meeting
...
During the BoFs session, many microGalaxy members discussed with admins how to improve reference data management, since most microbiological data analysis workflows require large reference data sets — such as [MetaPhlAn](https://bio.tools/metaphlan), [Kraken](https://bio.tools/kraken), and [GTDB](https://bio.tools/gtdbtk) databases — which are hard to keep up to date for the community. 
An intermediate solution is a [git-based IDC](https://github.com/usegalaxy-eu/IDC) update logic which pushes reference data to [CVMFS](https://cvmfs.readthedocs.io/), alongside a harmonizing effort between [usegalaxy.eu](https://usegalaxy.eu) and CVMFS. For the long run, Marius van den Beek will lead the development of **data bundles** that combine reference data with metadata to facilitate and speed up the management of reference data by enabling better integration of community efforts in updating it.

### CoFest

One major contribution of microGalaxy members to CoFest was a major update on the [CoDex](https://github.com/galaxyproject/galaxy_codex), speeding up the CI for resource collection (https://github.com/galaxyproject/galaxy_codex/pull/697), updating workflow and tutorial annotation and lab for the metabolomics community (https://github.com/galaxyproject/galaxy_codex/pull/711, https://github.com/galaxyproject/galaxy_codex/pull/712, https://github.com/galaxyproject/galaxy_codex/pull/710) and updating how the list of active galaxy servers is created (https://github.com/galaxyproject/galaxy_codex/pull/690).

### Acknowledgements

Special thanks to the GCC2026 organizers in Clermont-Ferrand for hosting a wonderful conference, and to all poster and talk authors as well as the CoFest and BoF participants for the productive discussions on reference data management and Galaxy Codex development.

Finally, we would like to acknowledge the support and hard work of all [microGalaxy SIG](https://galaxyproject.org/community/sig/microgalaxy/) members for their continued contributions to the community.

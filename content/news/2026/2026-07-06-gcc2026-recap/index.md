...
<figure style="margin: 1.5rem 0 2rem 0;">
  <img src="/images/events/gcc2026/GroupPhoto.jpg" alt="GCC2026 attendees gathered for the conference group photo in Clermont-Ferrand, France." style="width: 100%; border-radius: 12px;" />
</figure>

The 2026 Galaxy Community Conference brought the Galaxy community together in Clermont-Ferrand, France for a week of science, training, collaboration, and connection.
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1rem; margin: 1.5rem 0;">
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/Audience.jpg" alt="GCC2026 attendees in the audience during a conference session." style="width: 100%; border-radius: 10px;" />
  </figure>
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/Audience-2.jpg" alt="GCC2026 attendees listening during a conference talk." style="width: 100%; border-radius: 10px;" />
  </figure>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1rem; margin: 1.5rem 0;">
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/GalaxyLive-1.jpg" alt="Presenters demonstrating Galaxy features during Galaxy Live at GCC2026." style="width: 100%; border-radius: 10px;" />
  </figure>
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/GalaxyLive-2.jpg" alt="Galaxy Live presenters working together during a live demonstration." style="width: 100%; border-radius: 10px;" />
  </figure>
</div>
...
<figure style="margin: 1.5rem 0;">
  <img src="/images/events/gcc2026/Posters-1.jpg" alt="GCC2026 attendees discussing posters during a poster session." style="width: 100%; border-radius: 12px;" />
</figure>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1rem; margin: 1.5rem 0;">
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/BoFs.jpg" alt="GCC2026 attendees participating in a Birds of a Feather discussion." style="width: 100%; border-radius: 10px;" />
  </figure>
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/FishBowl-1.jpg" alt="Speakers participating in the GCC2026 fishbowl discussion." style="width: 100%; border-radius: 10px;" />
  </figure>
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/FishBowl-2.jpg" alt="GCC2026 fishbowl discussion with speakers and audience." style="width: 100%; border-radius: 10px;" />
  </figure>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1rem; margin: 1.5rem 0;">
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/Dinner.jpg" alt="GCC2026 attendees gathered outside during the conference dinner." style="width: 100%; border-radius: 10px;" />
  </figure>
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/Dinner-2.jpg" alt="GCC2026 attendees talking during the conference dinner in Clermont-Ferrand." style="width: 100%; border-radius: 10px;" />
  </figure>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1rem; margin: 1.5rem 0;">
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/GroupConvo.jpg" alt="GCC2026 attendees talking during a small group conversation." style="width: 100%; border-radius: 10px;" />
  </figure>
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/Tshirt.jpg" alt="A GCC2026 attendee wearing a Galaxy-themed T-shirt during a discussion." style="width: 100%; border-radius: 10px;" />
  </figure>
</div>
...
<div style="max-width: 850px; margin: 1.5rem auto;">
  <img
    src="/images/events/gcc2026/Scholarships.jpg"
    alt="GCC2026 scholarship and fellowship awardees standing together with organizers and community members."
...
Please see the [GCC2026 website](https://galaxyproject.org/events/gcc2026/fellowships/) to view all the fellowship and scholarship awardees for this year's conference.
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1rem; margin: 1.5rem 0;">
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/CoFest-1.jpg" alt="GCC2026 CoFest participants collaborating around laptops." style="width: 100%; border-radius: 10px;" />
  </figure>
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/CoFest-2.jpg" alt="GCC2026 CoFest participants working together at a table." style="width: 100%; border-radius: 10px;" />
  </figure>
  <figure style="margin: 0;">
    <img src="/images/events/gcc2026/CoFest-3.jpg" alt="A GCC2026 CoFest group discussing project work." style="width: 100%; border-radius: 10px;" />
  </figure>
</div>
...
Thank you to our Silver Sponsors, [Data Terra](https://www.data-terra.org/) and [PNDB](https://www.pndb.fr/), for supporting the conference and the Galaxy community.

Thank you to our Bronze Sponsors, [GalaxyWorks](https://galaxyworks.io/), [IFB](https://www.ifb-elixir.fr/), [de.NBI](https://www.denbi.de/), and [Limagrain](https://www.limagrain.com/), for helping make GCC2026 possible.

Thank you also to [SFBI](https://www.sfbi.fr/), our Friend of GCC sponsor, for supporting the event.
...
<figure style="margin: 1.5rem 0;">
  <img src="/images/events/gcc2026/Org.jpg" alt="Members of the GCC2026 organizing team standing together with a Galaxy banner." style="width: 100%; border-radius: 12px;" />
</figure>
...
Thank you to our hosts at [Université Clermont Auvergne](https://www.uca.fr/) and the [Institut Français de Bioinformatique / ELIXIR-France](https://www.ifb-elixir.fr/) for welcoming the Galaxy community to Clermont-Ferrand.

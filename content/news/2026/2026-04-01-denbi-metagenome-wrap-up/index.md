...
tease: "Outcomes of the 2026 Metagenome Training Course"
contributions:
  authorship:
    - paulzierep
  funding:
...
# Wrap-Up of the Galaxy Metagenome Training Course 2026

**Educators:** Paul Zierep (RBC), Daniel Wibberg (CAU), Nils Kleinbölting, Tom Tubbesing (BiGi)
**Course page:** [Galaxy Metagenome Training Course 2026](https://www.denbi.de/training-courses-2026/2018-galaxy-metagenome-training-course-2026)
...
On the second day, the workshop shifted to amplicon sequencing analysis. Using real datasets and guided tutorials (see [DADA2 16S tutorial](https://training.galaxyproject.org/training-material/topics/microbiome/tutorials/dada-16S/tutorial.html)), attendees processed and analyzed microbial community data step by step.
...
The course will be offered again early next year, expanded to **three days** to allow more in-depth WGS analysis. This event also served as a great warm-up for the upcoming **Galaxy Academy 2026**: [GTA 2026](https://training.galaxyproject.org/training-material/events/2026-05-18-galaxy-academy.html).
We hope that many of the participants will use this opportunity to deep dive into metagenomics with Galaxy!
...
If you are interested in joining this project, please reach out to **[zierep@informatik.uni-freiburg.de](mailto:zierep@informatik.uni-freiburg.de)**.

...
pull request (PR) to collect reference URLs in a response generated by LLM. The PR validates all the generated links 
and adds a references button shows all links returned in AI responses, improving transparency 

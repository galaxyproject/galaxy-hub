...
tags: [DaSCH, repository, data-commons, workflow, eosc, OCR, LLMHub, numarkdown, incunabula, Narrenschiff, deKCD, humanities]
contributions:
  authorship:
    - jnussbaum
    - Sch-Da
...
(Learn how to create a collection on [this FAQ page](https://training.galaxyproject.org/training-material/faqs/galaxy/collections_build_list.html))

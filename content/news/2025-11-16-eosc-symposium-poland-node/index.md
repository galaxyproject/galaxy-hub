...
2. Integrate remote data into [Onedata](https://onedata.org/#/home) spaces using the Node's data portal ([data.eosc.pl](https://data.eosc.pl/ozw/onezone/)).
...
Log in to [data.eosc.pl](https://data.eosc.pl/ozw/onezone/) for read-only access to the demo space.

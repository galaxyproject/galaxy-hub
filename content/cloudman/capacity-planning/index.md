...
**Be Aware:** The specific configuration details will depend on the cloud [infrastructure vendor and platform](/cloudman/capacity-planning/#platforms).
...
* [Amazon Web Services (AWS) Capacity Planning](/cloudman/aws/capacity-planning/)
* *... (others to be added)*

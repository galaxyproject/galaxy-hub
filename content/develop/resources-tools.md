...
* [A somewhat complete description](https://docs.galaxyproject.org/en/master/dev/schema.html) of tags used for in tool XML files.
...
* [A discussion](http://planemo.readthedocs.io/en/latest/writing_advanced.html#multiple-output-files) on outputing multiple individual datasets
* [Tips on writing secure tools](/develop/security-tool-tips).
* [Managing tools](/tools) from a Galaxy administrator perspective.
* Tool conversion and generation efforts:
    ...
    * [gxargparse](https://github.com/hexylena/argparse2tool) - a drop in replacement of Python's argparse to generate Galaxy tools by Helena Rasche.
...
* Popular tool repositories on [github](https://github.com/) to contribute to and serve as best practice examples:
    ...
    * [Bjoern's Galaxy Tools](https://github.com/bgruening/galaxytools) - A collection of tools developed and maintained by [Bjoern Gruening](/people/bjoern-gruening). ([Contributing to galaxytools](https://github.com/bgruening/galaxytools/blob/master/CONTRIBUTING.md))

...
![Workflows](/images/mpxv/mpxv-workflow-logic.svg)


Here is the info to get you started quickly:

- We have three [<kbd>workflows</kbd>](#workflows-for-discovery-of-sequence-variants) for analysis of Illumina data (Oxford nanopore workflows can also be added. Request [here](https://help.galaxyproject.org)).
...
| [WorkflowHub](https://workflowhub.eu/workflows/356)           |**Consensus building**:<br> Generation of consensus sequences from VCF datasets.<br><span class="badge badge-danger">CONSENSUS</span>                                                 | Variants [`vcf`] | Consensus [`multi fasta`] | - | - |
...
3. Run the <span class="badge badge-danger">REPORTING</span> workflow on variants generated above (#1) to produce consensus sequences.
...
- <span class="badge badge-danger">CONSENSUS</span> [workflow link](https://workflowhub.eu/workflows/356/git/1/raw/Galaxy-Workflow-Generic_consensus_construction_from_VCF_calls.ga)

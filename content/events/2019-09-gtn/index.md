...
Outside of these calls, we will have a **CoFest (Collaboration Fest)**. We will coordinate via [Hangout](https://hangouts.google.com/hangouts/_/calendar/Z2FsYXh5dW5pZnJlaWJ1cmdAZ21haWwuY29t.6nungcj20l9qh2uicb8h5ivpds) (drop-in channel we will keep open the whole day) and [the GTN Matrix channel](https://matrix.to/#/#Galaxy-Training-Network_Lobby:gitter.im).

---

*If you want to join to help or to talk and learn about the project, let us know on the [Matrix channel](https://matrix.to/#/#Galaxy-Training-Network_Lobby:gitter.im) or by leaving a comment on the [issue on GitHub](https://github.com/galaxyproject/training-material/issues/1491)*

...
Upload data to ENA | Miguel Roncoroni | [](https://training.galaxyproject.org/training-material/topics/galaxy-interface/tutorials/upload-data-to-ena/slides.html#1){: .fab .fa-slideshare target="_blank"} / [](https://training.galaxyproject.org/training-material/topics/galaxy-interface/tutorials/upload-data-to-ena/tutorial.html){: .fa .fa-laptop target="_blank"} / [](https://www.youtube.com/watch?v=sEjhWAtmAn4){: .fas .fa-video target="_blank"} | __Demo:__ *Learn how to submit your sequencing data to the ENA directly from Galaxy.*{: .small } | 1h / 10m
...
- **Hands-on tutorials** ([](){: .fa .fa-laptop}): a step-by-step explanation, including all the required information, to perform a data analysis, often available also as pre-recorded video ([](){: .fas .fa-video}).

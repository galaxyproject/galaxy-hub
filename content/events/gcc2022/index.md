...
<small>Photo: Chad Davis, Flickr, CC-BY NC SA 2.0</small>
  ...
  <!-- Schedule & Key Dates -->
  <div class="card" style="min-width: 35%; max-width: 30rem;">
...
**[Registration](/events/gcc2022/register/) and [abstract submission](/events/gcc2022/abstracts/) are open**.  Early registration provides significant discounts for all types of participants, and espectially students and post-docs. See the [Key Dates page](/events/gcc2022/key-dates/) for more.
...
**Share your work!**  There is no better place than GCC2022 to share your progress and challenges in doing and supporting data-intesive science. GCC2022 is soliciting long talks, lightning talks, poster presentations, and demo presentations.  **See the [Abstracts page](/events/gcc2022/abstracts/)** for details.
  ...
  <!-- Travel -->
  <div class="card" style="min-width: 30%; max-width: 20rem;">

...
![](/archive/automated-tool-tests/test_environment.png)
...
![](/archive/automated-tool-tests/missing_test_components.png)
...
![](/archive/automated-tool-tests/installation_errors.png)
...
![](/archive/automated-tool-tests/failing_tool_tests.png)
...
![](/archive/automated-tool-tests/skip_tool_tests.png)
...
![](/archive/automated-tool-tests/no_failing_tool_tests.png)
...
![](/archive/automated-tool-tests/both_pass_and_fail.png)
...
![](/archive/automated-tool-tests/owner_latest_revision_lists.png)
...
![](/archive/automated-tool-tests/latest_revision_lists.png)
...
![RSS feed of the development team's repositories on the test tool shed, displayed in Firefox.](/archive/automated-tool-tests/RSSFeedScreenShotInFirefox.png)

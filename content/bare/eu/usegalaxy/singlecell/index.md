...
This service is a joint project between different groups from the [Earlham Institute](http://www.earlham.ac.uk), the [Gene Expression Team](https://www.ebi.ac.uk/about/teams/gene-expression/) at [EMBL-EBI](https://www.ebi.ac.uk/), the [Teichmann Team](https://www.sanger.ac.uk/science/groups/teichmann-group) at the [Wellcome Sanger Institute](https://www.sanger.ac.uk/), [EMBL](https://gbcs.embl.de/) the [Sorbonne University](http://artbio.fr/), [Peter MacCallum Cancer Centre](https://www.petermac.org/) and the [University of Freiburg](https://galaxyproject.eu/freiburg/).
...
<Icon name="map" /> [Guided tour](https://singlecell.usegalaxy.eu/tours/core.galaxy_ui) through Galaxy's user interface.\

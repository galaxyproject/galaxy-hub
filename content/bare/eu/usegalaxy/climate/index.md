...
<img src="/assets/media/usegalaxy/climate/Galaxy-climate-logo.png" alt="Galaxy Climate" style="max-width: 50%; width: min(50%, 400px)"/>
...
_The Galaxy server that was used for some calculations is in part funded by Collaborative Research Centre 992 Medical Epigenetics (DFG grant SFB 992/1 2012) and

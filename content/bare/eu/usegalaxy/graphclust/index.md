...
- [Getting started](#getting-started)
  - [Results from the paper, shared histories](#results-from-the-paper-shared-histories)
...
[![GraphClust2 video thumbnail](/assets/media/usegalaxy/graphclust/video-thumbnail.png)](https://www.youtube.com/watch?v=fJ6tUt_6uas)
...
- The _MotifFinder_ workflow flavor targets identifying a handful of local signals/motifs under the likely presence of noise and sequence context.
  - MotifFinder: [GraphClust-MotifFinder](https://graphclust.usegalaxy.eu/u/graphclust2/w/graphclust2--motiffinder)

- The pre-configured _main_ workflows perform best for clustering and partitioning a set of RNA sequences with quasi defined structure boundary signals (e.g. ncRNAs or data from genomic screenings with tools such as CMfinder or RNAz screens). Usually one to three rounds of clustering would be enough for typical scenarios. You may find further suitable pre-configured flavors from the github directory page.
...
<img src="/assets/media/usegalaxy/graphclust/workflow_early.png" width="600" alt="GraphClust2 early workflow" /> ![GraphClust-2 workflow overview](/assets/media/usegalaxy/graphclust/figure-pipeline_zigzag.png)

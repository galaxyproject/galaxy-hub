...
[`/src`](https://github.com/galaxyproject/galaxy-hub/tree/master/src) &rarr; [`/src/community`](https://github.com/galaxyproject/galaxy-hub/tree/master/src/community)<br />
...
3. :hatched_chick: If the file is bigger than 1 meg then don't upload it.  Email it to outreach@galaxyproject.org instead.  We'll put it in the Galaxy Depot and then mail you a URL you can linke to.  (Keeping large files in GitHub is not a good use of GitHub.)

...
- [Basics](#basics)
  ...
  - [Markdown](#markdown)
- [Submiting your first edit through the GitHub web interface](#submiting-your-first-edit-through-the-github-web-interface)
...
Every page in the [Galaxy Hub](https://galaxyproject.org/) has a coresponding directory in GitHub.  For example, the contents of the GitHub directory at [/src/community/](/src/community/)
...
- Special characters in unquoted tag value. A lot of things, including hyphens can cause problmes.  If in doubt, quote it

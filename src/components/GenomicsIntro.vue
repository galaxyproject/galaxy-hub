    ...
    <div class="main">
        <div class="features">
            <div class="paper">
                <RouterLink :to="'/genomics/global_platform/'">
                    <h2>
                        Global Platform<sup><font color="red">new</font></sup>
                    </h2>
            ...
            <div class="paper">
                <RouterLink :to="'/genomics/no-more-business-as-usual/'">
                    ...
                    <h4>
                        No more business as usual: Agile and effective responses to emerging pathogen threats require
        ...
        <div class="features">
            ...
            <div class="feature">
                ...
                <ul>
                    <li>
                        <RouterLink :to="'/direct-rnaseq/1-preprocessing/'">Pre-Processing</RouterLink>
                    </li>
                    <li>
                        <RouterLink :to="'/direct-rnaseq/2-epigenetics/'">RNA Epigenetics</RouterLink>
                    </li>
                </ul>
            </div>
        </div>

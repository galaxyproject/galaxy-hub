    ...
    <div class="container-fluid-real mt-4 p-3 bgBright sectionLearn">
        <div class="container">
            <div class="row">
                ...
                <div class="col col-8">
                    <a :href="b.link" v-for="b in this.buttonContent" rile="button"  rel="noopener" target="_blank" class="btn btn-outline-primary text-left mb-4 ml-3">
        ...
        return {
            buttonContent: [
                ...
                },
                {
                    ...
                    text: "(Re)use or adapt quality workflows.",
                    link: "https://training.galaxyproject.org/training-material/workflows/list",
                },
                {
                    title: "Blog",
                    text: "Read highlights from the experts.",
                    link: "/blog/",
                },
                {
                    title: "Data",

---
title: The Manifesto: Global Galaxy Steering Committee Charter
---
...
<div class="lead">
[Galaxy](/src/index.md) is a mature, successful research software infrastructure project, with a large and diverse global audience. Changes in [project governance structures](/src/community/governance/index.md) are needed to help adapt to increasing complexity. The [Galaxy Executive Committee](/src/community/governance/exec/index.md) has formed the [Global Galaxy Steering Committee (GGSC)](/src/community/governance/steering/index.md) to represent the interests of communities engaged with the project, and to implement efficient consultative project governance structures for that purpose. **This document outlines the current charter for the GGSC.**
</div>

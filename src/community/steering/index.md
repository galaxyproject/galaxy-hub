...
<div class="lead">
The [Galaxy Executive Committee](/src/community/governance/exec/index.md) has formed the [Global Galaxy Steering Committee (GGSC)](/src/community/governance/steering/index.md) to represent the interests of communities engaged with the project, and to implement efficient consultative project governance structures for that purpose.
</div>

...
| Region | Info | Links |
|--------|------|-------|
| Arabic Community | The Galaxy Arabic speaking community supports Galaxy activity for the Arabic speaking community and Arabic speaking regions of the world. | [<i class="fa fa-twitter" aria-hidden="true"></i>](http://twitter.com/galaxy_arabic) [<i class="fa fa-envelope-o" aria-hidden="true"></i>](https://lists.galaxyproject.org/listinfo/galaxy-arabic) |

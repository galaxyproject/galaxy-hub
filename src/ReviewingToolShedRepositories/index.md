...
![](/src/ReviewingToolShedRepositories/tool_shed_roles.png)
...
![](/src/ReviewingToolShedRepositories/tool_shed_groups.png)
...
![](/src/ReviewingToolShedRepositories/iuc_group_members.png)
...
![](/src/ReviewingToolShedRepositories/reviewing_repositories_menu.png)
...
![](/src/ReviewingToolShedRepositories/review_components.png)
...
![](/src/ReviewingToolShedRepositories/filter.png)
...
![](/src/ReviewingToolShedRepositories/repositories_with_no_reviews.png)
...
![](/src/ReviewingToolShedRepositories/revision_reviews.png)
...
![](/src/ReviewingToolShedRepositories/manage_repository.png)
...
![](/src/ReviewingToolShedRepositories/view_tool_metadata.png)
...
![](/src/ReviewingToolShedRepositories/browse_repository_tip_files.png)
...
![](/src/ReviewingToolShedRepositories/new_review.png)
...
![](/src/ReviewingToolShedRepositories/functional_tests_review.png)

![](/src/ReviewingToolShedRepositories/tools_review.png)
...
![](/src/ReviewingToolShedRepositories/reviewed_repositories_i_own_menu_item.png)
...
![](/src/ReviewingToolShedRepositories/reviewed_repositories_i_own.png)
...
![](/src/ReviewingToolShedRepositories/filter_revision_reviews.png)
...
![](/src/ReviewingToolShedRepositories/filter_fb7df3011c2b_review.png)

After making the recommended corrections to the repository, the repository files hierarchy now look like this.

![](/src/ReviewingToolShedRepositories/filter_file_hierarchy.png)
...
![](/src/ReviewingToolShedRepositories/filter_changelog.png)
...
![](/src/ReviewingToolShedRepositories/repositories_reviewed_by_me.png)
...
![](/src/ReviewingToolShedRepositories/add_review_to_07d61f25cd35.png)
...
![](/src/ReviewingToolShedRepositories/copy_previous_review.png)
...
![](/src/ReviewingToolShedRepositories/filter_07d61f25cd35_review.png)
...
![](/src/ReviewingToolShedRepositories/revision_approved.png)

![](/src/ReviewingToolShedRepositories/functional_tests_review2.png)
...
![](/src/ReviewingToolShedRepositories/revision_07d61f25cd35_approved.png)

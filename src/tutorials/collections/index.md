...
## Multiple datasets are a hassle
...
|<small>To see a higher resolution image right-click [here](/src/tutorials/collections/creating_list.pdf)(</small>|
...
```
wget http://www.bx.psu.edu/~anton/share/ng_test_data/var/raw_child-ds-1.fq.gz
wget http://www.bx.psu.edu/~anton/share/ng_test_data/var/raw_child-ds-2.fq.gz
wget http://www.bx.psu.edu/~anton/share/ng_test_data/var/raw_mother-ds-1.fq.gz
wget http://www.bx.psu.edu/~anton/share/ng_test_data/var/raw_mother-ds-2.fq.gz
```

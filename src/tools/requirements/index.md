...
The tool developers specify these requirements within the [tool definition](/src/admin/tools/tool-config-syntax/index.md#a3crequirements3e-tag-set). These requirements along with their specified versions are visible to the user in the Galaxy UI when looking at the tool form for **informational purposes**.

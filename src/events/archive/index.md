...
<table class="table table-striped">
  ...
  <tr>
    <td> P22: <em>PIPE-CLIP: A comprehensive online tool for CLIP-seq data analysis</em><div class='indent'>(See <a href='/src/use/index.md#qbrc-galaxy-and-pipe-clip'>PIPE-CLIP</a>)</div> </td>
    <td> </td>

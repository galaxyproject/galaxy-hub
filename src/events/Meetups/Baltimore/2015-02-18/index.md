...
<div class="title">Feb 18, 2015 Baltimore Area Galaxy Meetup @ Johns Hopkins</div>
...
[Enis Afgan](/EnisAfgan) and [Nitesh Turaga](/NiteshTuraga) of the [Galaxy team](/GalaxyTeam) will be delivering a short introduction to the resources available to start using the Galaxy application from a practitioner's viewpoint (and will be available for any additional questions). 

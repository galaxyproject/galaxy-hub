...
1. [Afgan E](/src/EnisAfgan/index.md), [Goecks J](/src/JeremyGoecks/index.md), [Baker D](/src/DannonBaker/index.md), [Coraor N](/src/nate/index.md), the [Galaxy Team](/src/GalaxyTeam/index.md), [Nekrutenko A](/src/anton/index.md), and [Taylor J](/src/JamesTaylor/index.md). "[Galaxy - a Gateway to Tools in e-Science|&do=get](ATTACHMENT_URLDocuments/Papers/Galaxy_eScienceGateway.pdf)". *Guide to e-Science: Next Generation Scientific Research and Discovery*. K. Yang, Ed., ed: Springer. *in press*. p. 35.

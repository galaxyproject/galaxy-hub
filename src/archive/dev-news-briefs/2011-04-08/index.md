...
* New ***ClustalW*** wrapper (see http://www.clustal.org) for protein/dna multiple alignments based on the Galaxy *ClustalW* wrapper posted by [Hans-Rudolf Hotz](/src/hansrudolf-hotz/index.md) [in an email on the developer list](http://lists.bx.psu.edu/pipermail/galaxy-dev/2010-November/003732.html)

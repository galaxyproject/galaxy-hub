...
1. New ‘Dataset Chooser’ that allows the user to select one or more datasets from a particular source (current history, other histories, library datasets), [example](https://bitbucket.org/carlfeberhard/galaxy-visualization-dataset-choice), [wiki](https://wiki.galaxyproject.org/VisualizationsRegistry/Cookbook#how-can-i-add-a-way-for-the-user-to-select-a-different-.28or-additional.29-datasets.3f), and [future upgrades](https://trello.com/c/UfD9AMCi). 

...
![](/src/reviewing-toolshed-repositories/tool_shed_roles.png)
...
![](/src/reviewing-toolshed-repositories/tool_shed_groups.png)
...
![](/src/reviewing-toolshed-repositories/iuc_group_members.png)
...
![](/src/reviewing-toolshed-repositories/reviewing_repositories_menu.png)
...
![](/src/reviewing-toolshed-repositories/review_components.png)
...
![](/src/reviewing-toolshed-repositories/filter.png)
...
![](/src/reviewing-toolshed-repositories/repositories_with_no_reviews.png)
...
![](/src/reviewing-toolshed-repositories/revision_reviews.png)
...
![](/src/reviewing-toolshed-repositories/manage_repository.png)
...
![](/src/reviewing-toolshed-repositories/view_tool_metadata.png)
...
![](/src/reviewing-toolshed-repositories/browse_repository_tip_files.png)
...
![](/src/reviewing-toolshed-repositories/new_review.png)
...
![](/src/reviewing-toolshed-repositories/functional_tests_review.png)

![](/src/reviewing-toolshed-repositories/tools_review.png)
...
![](/src/reviewing-toolshed-repositories/reviewed_repositories_i_own_menu_item.png)
...
![](/src/reviewing-toolshed-repositories/reviewed_repositories_i_own.png)
...
![](/src/reviewing-toolshed-repositories/filter_revision_reviews.png)
...
![](/src/reviewing-toolshed-repositories/filter_fb7df3011c2b_review.png)

After making the recommended corrections to the repository, the repository files hierarchy now look like this.

![](/src/reviewing-toolshed-repositories/filter_file_hierarchy.png)
...
![](/src/reviewing-toolshed-repositories/filter_changelog.png)
...
![](/src/reviewing-toolshed-repositories/repositories_reviewed_by_me.png)
...
![](/src/reviewing-toolshed-repositories/add_review_to_07d61f25cd35.png)
...
![](/src/reviewing-toolshed-repositories/copy_previous_review.png)
...
![](/src/reviewing-toolshed-repositories/filter_07d61f25cd35_review.png)
...
![](/src/reviewing-toolshed-repositories/revision_approved.png)

![](/src/reviewing-toolshed-repositories/functional_tests_review2.png)
...
![](/src/reviewing-toolshed-repositories/revision_07d61f25cd35_approved.png)

...
![](/src/reviewing-tool-shed-repositories/tool_shed_roles.png)
...
![](/src/reviewing-tool-shed-repositories/tool_shed_groups.png)
...
![](/src/reviewing-tool-shed-repositories/iuc_group_members.png)
...
![](/src/reviewing-tool-shed-repositories/reviewing_repositories_menu.png)
...
![](/src/reviewing-tool-shed-repositories/review_components.png)
...
![](/src/reviewing-tool-shed-repositories/filter.png)
...
![](/src/reviewing-tool-shed-repositories/repositories_with_no_reviews.png)
...
![](/src/reviewing-tool-shed-repositories/revision_reviews.png)
...
![](/src/reviewing-tool-shed-repositories/manage_repository.png)
...
![](/src/reviewing-tool-shed-repositories/view_tool_metadata.png)
...
![](/src/reviewing-tool-shed-repositories/browse_repository_tip_files.png)
...
![](/src/reviewing-tool-shed-repositories/new_review.png)
...
![](/src/reviewing-tool-shed-repositories/functional_tests_review.png)

![](/src/reviewing-tool-shed-repositories/tools_review.png)
...
![](/src/reviewing-tool-shed-repositories/reviewed_repositories_i_own_menu_item.png)
...
![](/src/reviewing-tool-shed-repositories/reviewed_repositories_i_own.png)
...
![](/src/reviewing-tool-shed-repositories/filter_revision_reviews.png)
...
![](/src/reviewing-tool-shed-repositories/filter_fb7df3011c2b_review.png)

After making the recommended corrections to the repository, the repository files hierarchy now look like this.

![](/src/reviewing-tool-shed-repositories/filter_file_hierarchy.png)
...
![](/src/reviewing-tool-shed-repositories/filter_changelog.png)
...
![](/src/reviewing-tool-shed-repositories/repositories_reviewed_by_me.png)
...
![](/src/reviewing-tool-shed-repositories/add_review_to_07d61f25cd35.png)
...
![](/src/reviewing-tool-shed-repositories/copy_previous_review.png)
...
![](/src/reviewing-tool-shed-repositories/filter_07d61f25cd35_review.png)
...
![](/src/reviewing-tool-shed-repositories/revision_approved.png)

![](/src/reviewing-tool-shed-repositories/functional_tests_review2.png)
...
![](/src/reviewing-tool-shed-repositories/revision_07d61f25cd35_approved.png)

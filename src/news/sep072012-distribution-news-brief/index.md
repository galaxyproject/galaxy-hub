...
* Streamline local setup with the **[Reference Genome rsync Server](/src/Admin/DataIntegration/index.md)**: same builds and indexes as on the public **Galaxy [Main](/src/Main/index.md)** instance.

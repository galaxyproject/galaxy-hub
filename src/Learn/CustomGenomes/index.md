...
In [Galaxy](http://usegalaxy.org), a ** *custom* reference genome** is a [FASTA](/Learn/Datatypes.md#fasta) formatted [dataset](/Learn.md#datasets) that can be used in place of a ** *native* reference genome** with most tools. 
...
* obtain a **[FASTA](/Learn/Datatypes.md#fasta) copy of the target genome**
* **[FTP](/FTPUpload) the genome to Galaxy** and load into a history as a [dataset](/Learn.md#datasets)
...
<br />
# Format
* Custom Genomes are required to be in [FASTA](/Learn/Datatypes.md#fasta) format
* The data should be formatted as [FASTA](/Learn/Datatypes.md#fasta) prior to upload into Galaxy
* The dataset will need to be labeled as [FASTA](/Learn/Datatypes.md#fasta) after loaded (if not automatically assigned)
<br />
# Custom Builds
Some tools and functions require that the ['database' attribute is assigned](/Support.md#tool_doesn27t_recognize_dataset) or that a Custom Reference Genome is set up as a *Custom Build* prior to use. Examples are the tool **Extract Genomic DNA**, certain **Picard** tools, and the function **Visualization**. 
...
<table>
  ...
  <tr>
    <td> 1.</td>
    <td> Custom genome not assigned as <a href='/Learn/Datatypes.md#fasta'>FASTA</a> format </td>
    <td> Dataset not included in custom genome pull down menu on tool forms </td>
    <td> check datatype assigned to dataset </td>
    <td> Click on the dataset's pencil icon <img src='/Images/Icons/pencil.png' /> to reach the "Edit Attributes" page, and in the <a href='/Learn/Datatypes.md'>datatypes</a> section, type in "fasta", and save </td>
  </tr>
  <tr>
    <td> 2.</td>
    ...
    <td> Reload (switch to </strong><a href='/FTPUpload.md'>FTP</a><strong> if not using already). Check your FTP client logs if used for prior load. Or just reload. </td>
  </tr>
  <tr>
    <td> 3.</td>
    <td> Extra spaces, extra lines, inconsistent line wrapping, any deviation from strict <a href='/Learn/Datatypes.md#fasta'>FASTA</a> format </td>
  ...
  <tr>
    ...
    <td> To sort, follow instructions for <a href='/Learn/CustomGenomes.md#sorting'>Sorting</a> a Custom Genome </td>
  </tr>
  <tr>
    <td> 6.</td>
  ...
  <tr>
    ...
    <td> Create a <a href='/Learn/CustomGenomes.md#custom_builds'>Custom Build</a> and assign it to the dataset </td>
  </tr>
</table>

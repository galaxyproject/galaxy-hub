...
<img src="/src/public-galaxy-servers/80PlusSlide.png" alt="and counting" class="img-responsive center-block" />
...
<div class="alert alert-success" role="alert"> **To add** your public Galaxy server to this list [describe the server here](https://docs.google.com/forms/d/1KBkyhAPpgJLanRWBoIHmwtEJELDUifZLUixfoqZXXU4/viewform?usp=send_form) and we'll post it this directory.</div>

...
[Back to Support Hub](/src/galaxyproject.org/support/index.md)
...
On the public Galaxy Main server at https://usegalaxy.org, datasets are public but unlisted by default. If working at a different Galaxy server, contact the administrators for clarification. Contact information is commonly found on the home page of a server or included on known public Galaxy Server's [directory pages](/src/use/index.md).
</div>

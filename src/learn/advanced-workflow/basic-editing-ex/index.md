...
*If you **[extracted a workflow from a history](/src/learn/advanced-workflow/extract/index.md)**, and find that a **run is producing an error**, enter the workflow editor to **double check tool connections** and to **modify datatype assignments** (if needed) as one of your first customizing steps.*
<br /> <br />

...
This document assumes that you are in the Admin perspective which is available only to [admin users](/src/Admin/Interface/index.md) 
...
library permissions for non-admin users, see our [Data Libraries Security page](/src/Admin/DataLibraries/LibrarySecurity/index.md).
...
![](/src/DataLibraries/library_popup_menu.png)
...
![](/src/DataLibraries/create_form.png)
...
![](/src/DataLibraries/add_template.png)
...
![](/src/DataLibraries/library_info.png)
...
![](/src/DataLibraries/upload_dataset.png)
...
![](/src/DataLibraries/dataset_info.png)
...
![](/src/DataLibraries/create_folder.png)
...
![](/src/DataLibraries/folder_info1.png)
...
![](/src/DataLibraries/edit_template.png)

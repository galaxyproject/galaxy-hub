...
See this [related page](/src/toolshed/installing-and-compiling-packages/index.md).
...
See this [related page](/src/toolshed/simple-repository-dependencies/index.md).

# Installing repositories that include complex repository dependency definitions

See this [related page](/src/toolshed/complex-repository-dependencies/index.md).

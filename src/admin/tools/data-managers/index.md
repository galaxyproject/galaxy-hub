...
The most up-to-date methods, including how to use Data Manager repositories in the [ToolShed](/src/tool-shed/index.md): [Events/GCC2014/TrainingDay](/src/events/gcc2014/training-day/index.md#tool_development_from_bright_idea_to_toolshed_-_data_managers)

...
* **Solution**: Use another [Public Galaxy](/src/use/index.md) or start up your own [Cloud Galaxy](/src/cloud/index.md), plus follow us at [Twitter](https://twitter.com/galaxyproject) for the most current [Main](/src/main/index.md) status updates
  ...
  * Is your reference genome not at the other server? If [FTP](/src/ftp-upload/index.md) available, try using a [Custom Genome](/src/support/index.md#custom_reference_genome) (on tool forms, option: *Using a reference genome from the history*)

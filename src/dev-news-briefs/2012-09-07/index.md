...
As reported in the *[July 20th, 2012 News Brief](/src/dev-news-briefs/2012-07-20/index.md)*, several changes have been made to the underlying code that determines run result state from tool exit codes and output. There are now additional enhancements to applying regular expressions and exit code checks. [Read more...](/src/admin/tools/tool-config-syntax/index.md#a3cstdio3e2c_3cregex3e2c_and_3cexit_code3e_tag_sets)
...
* *General*
  * Fix permissions problems on `stdout/stderr/errorcode` files when running jobs as the [real system user](/src/dev-news-briefs/2012-01-27/index.md#run_cluster_jobs_as_the_real_user).

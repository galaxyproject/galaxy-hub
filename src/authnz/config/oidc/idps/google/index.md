...
![image](/src/authnz/oidc/gdc_credentials.png)
...
4. Create a _Project_:
    ...
    ![image](/src/authnz/oidc/gdc_previous_project.png)
    
    2. In the create project page, enter project name and hit Create.
    
    ![image](/src/authnz/oidc/gdc_create_project.png)
    ...
    ![image](/src/authnz/oidc/gdc_consent.png)
...
5. Hit _Create credentials_ button in credentials tab, and choose _OAuth client ID_ from the popped-up window.
    ...
    ![image](/src/authnz/oidc/gdc_create_credentials.png)
    ...
    ![image](/src/authnz/oidc/gdc_result.png)
